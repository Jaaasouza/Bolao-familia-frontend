...
const IA_TXT = {
  ...
  pt: {
    install: '📲 Instale o app',
    iosLead: `Adicione o ${APP_NAME} à sua tela de início para acesso com um toque e avisos dos jogos:`,
    iosShare: 'Toque no', iosShareBtn: 'botão Compartilhar no Safari',
    iosAdd: 'Escolha', iosAddBtn: 'Adicionar à Tela de Início', iosDone: 'Toque em', iosDoneBtn: 'Adicionar — pronto!',
    installed: '✓ Instalado! Abra pela sua tela de início.',
    androidLead: `Adicione o ${APP_NAME} ao seu aparelho para acesso com um toque e avisos dos jogos.`,
    androidBtn: 'Instalar como app',
    browserLead: 'Use o menu do seu navegador →', browserBtn: 'Instalar app', browserOr: '/', browserAdd: 'Adicionar à tela de início', browserTail: 'para acesso com um toque.',
    alerts: '🔔 Avisos dos jogos',
    notify: '🔔 Me avise dos meus pontos depois de cada jogo que eu palpitei.',
    enabled: '✓ Notificações ativadas',
    blocked: 'As notificações estão bloqueadas nas suas configurações — ative-as para este site para receber avisos.',
    iosNote: 'No iPhone, as notificações funcionam depois de adicionar o app à tela de início.',
  },
};
